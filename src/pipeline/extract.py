"""
Módulo responsável pela extração de dados de APIs externas.
Este módulo contém funcionalidades para acessar, extrair e validar
dados provenientes de fontes API REST.
"""
